...
function Reportes() {
  ...
  useEffect(() => {
    axios.get("http://127.0.0.1:8000/api/cultivos/", getAuthHeaders())
  ...
  useEffect(() => {
    if (filtro.cultivo) {
      axios.get(`http://127.0.0.1:8000/api/unidades/?cultivo=${filtro.cultivo}`, getAuthHeaders())
  ...
  useEffect(() => {
    if (filtro.lote) {
      axios.get(`http://127.0.0.1:8000/api/experimentos/?unidad=${filtro.lote}`, getAuthHeaders())
  ...
  useEffect(() => {
    ...
    const cargarGraficos = async () => {
      try {
        let url = `http://127.0.0.1:8000/api/reporte-grafico/?cultivo=${filtro.cultivo}`;
